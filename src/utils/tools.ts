...
const checkChinaPhoneNumber = (phoneNumber: string): boolean => {
    return regexChina.test(phoneNumber);
}
export { createUUID, getOpenid, getPondTypeInChinese, checkChinaPhoneNumber };